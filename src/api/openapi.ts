  ...
  paths: {
    ...
    '/api/crawl': {
      post: {
        ...
        description:
          'Crawl a website starting from the specified URL. Discovers and visits links according to configured depth and URL limits.',
        tags: ['Crawling'],
        requestBody: {
          required: true,
          content: {
        ...
        responses: {
          ...
          '500': { description: 'Crawl operation failed' },
        },
      },
    },
    '/api/test': {
      post: {
        ...
        description:
          'Run accessibility tests on a single page using axe-core. Returns WCAG violations, passes, and incomplete tests with optional AI analysis.',
        tags: ['Accessibility'],
        requestBody: {
          required: true,
          content: {
        ...
        responses: {
          ...
          '500': { description: 'Test execution failed' },
        },
      },
    },
    '/api/test-multiple': {
      post: {
        ...
        description:
          'Run accessibility tests on multiple pages. Returns aggregated results for all tested URLs.',
        tags: ['Accessibility'],
        requestBody: {
          required: true,
          content: {
    ...
    '/api/combined': {
      post: {
        ...
        description:
          'Combined operation that crawls a website and runs accessibility tests on all discovered pages. Returns comprehensive results for the entire site.',
        tags: ['Combined'],
        requestBody: {
          required: true,
          content: {
