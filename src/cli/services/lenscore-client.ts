      ...
      const response = await this.fetchWithRetry(
        `${this.baseUrl}/api/test`,
        {
          ...
          body: JSON.stringify({
            ...
            customRulesConfig: options.customRulesConfig || [],
            customRulesPaths: options.customRulesPaths || [],
            disableDefaultRules: options.disableDefaultRules || [],
            enableDefaultRules: options.enableDefaultRules || [],
            includeApprovedRules: options.includeApprovedRules !== false,
            enableAI: options.enableAI,
            aiApiKey: options.openaiKey,
            projectContext: options.projectContext,
            skipCache: options.skipCache || false,
