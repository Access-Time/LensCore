...
export async function configCommand(options: any) {
  ...
  try {
    ...
    try {
      ...
      console.log(chalk.yellow('No configuration found. Run "lens-core setup" first.'));
      return;
    }
    ...
    if (options.set) {
      ...
      console.log(chalk.gray('• lens-core config --get <key> (get specific value)'));
      console.log(chalk.gray('• lens-core config --set <key=value> (set value)'));
    }
