...
export async function setupCommand() {
  ...
  try {
    ...
    if (!dockerAvailable) {
      ...
      console.log(chalk.red('Please install Docker first: https://docs.docker.com/get-docker/'));
      process.exit(1);
    }
    ...
    console.log(chalk.gray('2. Remote mode (connect to existing LensCore instance)'));
