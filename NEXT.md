...
1. ✅ **Pendekatan pertama** → fokus pada _tahapan pengembangan fitur per modul (setup, docker, API, UI, dsb)_.
2. 📦 **Pendekatan kedua** → fokus pada _packaging sebagai NPM CLI_, dengan command UX yang simpel kayak:
...
Bangun kerangka CLI modular dan _entry command_ (`setup`).
