...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en","dir":"ltr","title":"LensCore","description":"Open-source accessibility testing and web crawling platform","base":"/LensCore/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/img/logo.jpeg","sidebarMenuLabel":"Menu","returnToTopLabel":"Back to top","socialLinks":[{"icon":"github","link":"https://github.com/Access-Time/LensCore"}],"footer":{"message":"Released under the MIT License.","copyright":"Made with ❤️ by the AccessTime team"},"search":{"provider":"local","options":{"locales":{"id":{"translations":{"button":{"buttonText":"Cari","buttonAriaLabel":"Cari dokumentasi"},"modal":{"displayDetails":"Tampilkan detail","resetButtonTitle":"Reset pencarian","backButtonTitle":"Tutup pencarian","noResultsText":"Tidak ada hasil untuk","footer":{"selectText":"untuk memilih","selectKeyAriaLabel":"masuk","navigateText":"untuk navigasi","navigateUpKeyAriaLabel":"panah atas","navigateDownKeyAriaLabel":"panah bawah","closeText":"untuk menutup","closeKeyAriaLabel":"escape"}}}}}}}},"locales":{"root":{"label":"English","lang":"en","link":"/en/","themeConfig":{"nav":[{"text":"Home","link":"/en/"},{"text":"Documentation","link":"/en/getting-started"},{"text":"API","link":"/en/api"},{"text":"CLI","link":"/en/cli"},{"text":"Contributing","link":"/en/contributing"}],"sidebar":{"/en/":[{"text":"Getting Started","items":[{"text":"Introduction","link":"/en/getting-started"},{"text":"Installation","link":"/en/getting-started#installation"},{"text":"Quick Start","link":"/en/getting-started#quick-start"}]},{"text":"CLI","items":[{"text":"Overview","link":"/en/cli"},{"text":"Commands","link":"/en/cli#commands"},{"text":"Examples","link":"/en/cli#examples"}]},{"text":"API Reference","items":[{"text":"Overview","link":"/en/api"},{"text":"Endpoints","link":"/en/api#endpoints"}]},{"text":"Guides","items":[{"text":"Accessibility","link":"/en/accessibility"},{"text":"Contributing","link":"/en/contributing"}]}]},"editLink":{"pattern":"https://github.com/Access-Time/LensCore/edit/main/docs/:path","text":"Edit this page on GitHub"},"lastUpdated":{"text":"Last updated","formatOptions":{"dateStyle":"medium","timeStyle":"short"}}}},"id":{"label":"Bahasa Indonesia","lang":"id","link":"/id/","themeConfig":{"nav":[{"text":"Beranda","link":"/id/"},{"text":"Dokumentasi","link":"/id/getting-started"},{"text":"API","link":"/id/api"},{"text":"CLI","link":"/id/cli"},{"text":"Kontribusi","link":"/id/contributing"}],"sidebar":{"/id/":[{"text":"Memulai","items":[{"text":"Pengenalan","link":"/id/getting-started"},{"text":"Instalasi","link":"/id/getting-started#installation"},{"text":"Mulai Cepat","link":"/id/getting-started#quick-start"}]},{"text":"CLI","items":[{"text":"Ringkasan","link":"/id/cli"},{"text":"Perintah","link":"/id/cli#commands"},{"text":"Contoh","link":"/id/cli#examples"}]},{"text":"Referensi API","items":[{"text":"Ringkasan","link":"/id/api"},{"text":"Endpoints","link":"/id/api#endpoints"}]},{"text":"Panduan","items":[{"text":"Aksesibilitas","link":"/id/accessibility"},{"text":"Kontribusi","link":"/id/contributing"}]}]},"editLink":{"pattern":"https://github.com/Access-Time/LensCore/edit/main/docs/:path","text":"Edit halaman ini di GitHub"},"lastUpdated":{"text":"Terakhir diperbarui","formatOptions":{"dateStyle":"medium","timeStyle":"short"}},"docFooter":{"prev":"Sebelumnya","next":"Selanjutnya"},"outline":{"label":"Di halaman ini"},"returnToTopLabel":"Kembali ke atas","sidebarMenuLabel":"Menu","darkModeSwitchLabel":"Tema","lightModeSwitchTitle":"Ganti ke mode terang","darkModeSwitchTitle":"Ganti ke mode gelap"}}},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$t = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.xMm7u2yB.js"));
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "swagger-container" }, _attrs))} data-v-181ead4e><div id="swagger-ui" data-v-181ead4e></div></div>`);
    };
  }
});
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/SwaggerUI.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const SwaggerUI = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-181ead4e"]]);
const RawTheme = {
  extends: theme,
  enhanceApp({ app }) {
